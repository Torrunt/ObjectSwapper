...
public class Object_Swapper : EditorWindow
{
     ...
     private void OnEnable()
     {
          if (EditorGUIUtility.isProSkin)
               skin = EditorGUIUtility.Load("Packages/com.onewheelstudio.objectswapper/Resources/EasyUI_DarkSKin.guiskin") as GUISkin;
          else
               skin = EditorGUIUtility.Load("Packages/com.onewheelstudio.objectswapper/Resources/EasyUI_LightSkin.guiskin") as GUISkin;

          OWS = Resources.Load("Packages/com.onewheelstudio.objectswapper/Resources/OWS.png") as Texture2D;
     }
